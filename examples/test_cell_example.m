function test_cell_example()
% tests the cell example

% load cell example
pattern = load('cell256.mat');
...
alpha = 0.1;
load('test_cell.mat'); %Psi = []; % % need to compute a new test before
...
% store segmentations as images
d = load('cell_segments.mat');
d = d.d;
